...
async def command_start_handler(message: Message, assets_service: AssetsService) -> None:
...
async def show_menu(callback: CallbackQuery, assets_service: AssetsService) -> None:
